(set-logic HORN)
(set-info :source |
  Benchmark: ../golem/build/DoubleNestedLoopSimpleOneUNSAT.c
...
(assert
  (forall ((x0!16 Int) (x1!17 Int) (x2!18 Int) (x3!19 Int))
    (=> (and (< x2!18 50)
             ($main_inv3 x0!16 x1!17 x2!18 x3!19))
        ($main_inv3 x0!16 x1!17 (+ x2!18 1) x3!19))))
...
(assert
  (forall ((x0!24 Int) (x1!25 Int) (x2!26 Int) (x3!27 Int))
    (=> (and (> x2!26 0)
             ($main_inv4 x0!24 x1!25 x2!26 x3!27))
        ($main_inv4 x0!24 x1!25 (- x2!26 20) x3!27))))
...
(assert
  (forall ((x0!36 Int) (x1!37 Int) (x2!38 Int) (x3!39 Int))
    (=> (and (> x0!36 0)
             ($main_inv5 x0!36 x1!37 x2!38 x3!39))
        ($main_inv5 (- x0!36 1) (- x1!37 1) x2!38 (+ x3!39 2)))))
