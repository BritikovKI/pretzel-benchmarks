(set-logic HORN)
(set-info :source |
  Benchmark: ../golem/build/DoubleNestedLoopMinimalSATI1.c
...
(assert
  (forall ((x3!19 Int) (x2!18 Int) (x3!15 Int) (x0!12 Int) (x0!16 Int) (x1!13 Int) (x2!14 Int) (x1!17 Int))
    (=> (and (< (+ x0!16 1) 12)
        ...
        ($main_if3 x0!12 x1!13 x2!14 x3!15 (+ x0!16 1) (+ x1!17 1) (- x2!18 1) (- x3!19 1)))))
...
(assert
  (forall ((x3!19 Int) (x2!18 Int) (x3!15 Int) (x0!12 Int) (x0!16 Int) (x1!13 Int) (x2!14 Int) (x1!17 Int))
    (=> (and (not (< (+ x0!16 1) 12))
             ($main_if2 x0!12 x1!13 x2!14 x3!15 x0!16 x1!17 x2!18 x3!19))
        ($main_if3 x0!12 x1!13 x2!14 x3!15 (+ x0!16 1) (+ x1!17 1) (- x2!18 1) x3!19))))
