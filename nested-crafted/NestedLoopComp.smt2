(set-logic HORN)
(set-info :source |
  Benchmark: ../golem/build/NestedLoopComp.c
...
; loop entry $main_inv2 (line 14)
(assert
  (forall ((x0!8 Int) (x2!10 Int) (x1!9 Int) (x3!11 Int))
    (=> (and (< x3!11 3)
             ($main_inv1 x0!8 x1!9 x2!10 x3!11))
        ($main_inv2 (- x0!8 x2!10) x1!9 x2!10 x3!11))))

; loop term $main_sum2 (line 14)
(assert
...
; forwards $main_inv2 (line 14)
(assert
  (forall ((x0!12 Int) (x1!13 Int) (x2!14 Int) (x3!15 Int))
    (=> (and (< x0!12 300)
             ($main_inv2 x0!12 x1!13 x2!14 x3!15))
        ($main_inv2 (+ x0!12 10) (+ x1!13 1) (- x2!14 1) x3!15))))

; forwards $main_inv1 (line 12)
(assert
  (forall ((x0!16 Int) (x1!17 Int) (x2!18 Int) (x3!19 Int))
    (=> (and ($main_sum2 x0!16 x1!17 x2!18 x3!19))
        ($main_inv1 x0!16 x1!17 x2!18 (+ x3!19 1)))))

; loop entry $main_inv3 (line 22)
(assert
  (forall ((x0!20 Int) (x1!21 Int) (x2!22 Int) (x3!23 Int))
    (=> (and ($main_sum1 x0!20 x1!21 x2!22 x3!23))
        ($main_inv3 x0!20 x1!21 x2!22 x3!23))))

; loop term $main_sum3 (line 22)
(assert
  (forall ((x0!24 Int) (x1!25 Int) (x2!26 Int) (x3!27 Int))
    (=> (and (not (< x2!26 0))
             ($main_inv3 x0!24 x1!25 x2!26 x3!27))
        ($main_sum3 x0!24 x1!25 x2!26 x3!27))))

; loop entry $main_inv4 (line 24)
(assert
  (forall ((x0!24 Int) (x1!25 Int) (x2!26 Int) (x3!27 Int))
    (=> (and (< x2!26 0)
             ($main_inv3 x0!24 x1!25 x2!26 x3!27))
        ($main_inv4 x0!24 x1!25 (+ x2!26 5) x3!27))))

; loop term $main_sum4 (line 24)
(assert
  (forall ((x0!28 Int) (x1!29 Int) (x2!30 Int) (x3!31 Int))
    (=> (and (not (> x3!31 0))
             ($main_inv4 x0!28 x1!29 x2!30 x3!31))
        ($main_sum4 x0!28 x1!29 x2!30 x3!31))))

; forwards $main_inv4 (line 24)
(assert
  (forall ((x0!28 Int) (x1!29 Int) (x2!30 Int) (x3!31 Int))
    (=> (and (> x3!31 0)
             ($main_inv4 x0!28 x1!29 x2!30 x3!31))
        ($main_inv4 (+ x0!28 1) x1!29 x2!30 (- x3!31 1)))))

; loop entry $main_inv5 (line 29)
(assert
  (forall ((x0!32 Int) (x1!33 Int) (x2!34 Int) (x3!35 Int))
    (=> (and ($main_sum4 x0!32 x1!33 x2!34 x3!35))
        ($main_inv5 x0!32 x1!33 x2!34 (+ x3!35 5)))))
