(set-logic HORN)
(set-info :source |
  Benchmark: ../golem/build/DoubleNestedLoopMinimalSATA.c
...
; loop entry $main_inv4 (line 19)
(assert
  (forall ((x0!20 Int) (x1!21 Int) (x2!22 Int) (x3!23 Int))
    (=> (and (> x0!20 0)
             ($main_inv3 x0!20 x1!21 x2!22 x3!23))
        ($main_inv4 (- x0!20 1) x1!21 x2!22 x3!23))))

; loop term $main_sum4 (line 19)
(assert
...
; forwards $main_inv4 (line 19)
(assert
  (forall ((x0!24 Int) (x1!25 Int) (x2!26 Int) (x3!27 Int))
    (=> (and (< x2!26 50)
             ($main_inv4 x0!24 x1!25 x2!26 x3!27))
        ($main_inv4 x0!24 x1!25 (+ x2!26 1) x3!27))))

; loop entry $main_inv5 (line 23)
(assert
  (forall ((x0!28 Int) (x1!29 Int) (x2!30 Int) (x3!31 Int))
    (=> (and ($main_sum4 x0!28 x1!29 x2!30 x3!31))
        ($main_inv5 x0!28 (- x1!29 1) x2!30 x3!31))))

; loop term $main_sum5 (line 23)
(assert
  (forall ((x0!32 Int) (x1!33 Int) (x2!34 Int) (x3!35 Int))
    (=> (and (not (> x2!34 0))
             ($main_inv5 x0!32 x1!33 x2!34 x3!35))
        ($main_sum5 x0!32 x1!33 x2!34 x3!35))))

; forwards $main_inv5 (line 23)
(assert
  (forall ((x0!32 Int) (x1!33 Int) (x2!34 Int) (x3!35 Int))
    (=> (and (> x2!34 0)
             ($main_inv5 x0!32 x1!33 x2!34 x3!35))
        ($main_inv5 x0!32 x1!33 (- x2!34 20) x3!35))))

; if then
(assert
  (forall ((x1!21 Int) (x2!22 Int) (x0!36 Int) (x1!37 Int) (x3!39 Int) (x2!38 Int) (x3!23 Int) (x0!20 Int))
    (=> (and (< x0!36 1)
             ($main_sum5 x0!36 x1!37 x2!38 x3!39))
        ($main_if2 x0!20 x1!21 x2!22 x3!23 (+ x0!36 1) x1!37 x2!38 x3!39))))
...
(assert
  (forall ((x1!21 Int) (x2!22 Int) (x0!36 Int) (x1!37 Int) (x3!39 Int) (x2!38 Int) (x3!23 Int) (x0!20 Int))
    (=> (and (not (< x0!36 1))
             ($main_sum5 x0!36 x1!37 x2!38 x3!39))
        ($main_if2 x0!20 x1!21 x2!22 x3!23 x0!36 x1!37 x2!38 x3!39))))

; forwards $main_inv3 (line 17)
(assert
  (forall ((x1!21 Int) (x1!41 Int) (x2!22 Int) (x0!40 Int) (x3!23 Int) (x0!20 Int) (x3!43 Int) (x2!42 Int))
    (=> (and ($main_if2 x0!20 x1!21 x2!22 x3!23 x0!40 x1!41 x2!42 x3!43))
        ($main_inv3 x0!40 x1!41 x2!42 x3!43))))

; forwards $main_inv1 (line 12)
(assert
  (forall ((x0!44 Int) (x1!45 Int) (x2!46 Int) (x3!47 Int))
    (=> (and ($main_sum3 x0!44 x1!45 x2!46 x3!47))
        ($main_inv1 x0!44 x1!45 x2!46 x3!47))))

; VERIFIER_assert (> x1!49 0)
(assert
  (forall ((x1!49 Int) (x0!48 Int) (x2!50 Int) (x3!51 Int))
    (=> (and (not (> x1!49 0))
             ($main_sum1 x0!48 x1!49 x2!50 x3!51))
        false)))
