...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (count Int) (|count'| Int)) (=> (and (= |_FH_0'| (- _FH_0 1)) (NEST count _FH_0) (= |count'| (+ count 1))) (WRAP |count'| |_FH_0'|))))

(assert (forall ((_FH_0 Int) (count Int) (|count'| Int)) (=> (and (< _FH_0 0) (WRAP count _FH_0) (= |count'| (+ count 1))) (fail |count'|))))
